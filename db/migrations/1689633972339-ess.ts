...
export class Ess1689633972339 implements MigrationInterface {
    name = 'Ess1689633972339'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`post\` ADD \`hashtags\` varchar(255) NOT NULL`);
